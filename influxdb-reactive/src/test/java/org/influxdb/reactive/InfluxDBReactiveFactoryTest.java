...
import static org.influxdb.reactive.BatchOptionsReactive.DEFAULTS;
...
class InfluxDBReactiveFactoryTest {
    ...
    void listenerRequired() {
        ...
        Assertions
                .assertThatThrownBy(() -> InfluxDBReactiveFactory.connect(options, DEFAULTS, null))
                .isInstanceOf(NullPointerException.class)
                .hasMessage("InfluxDBReactiveListener is required");
    }
}